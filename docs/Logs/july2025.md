...
- [ ] Create private repo dayBook: Engineer book. (substitue for docx diary)

### TODO

- [X] DW expo-lab: #18-refactor and test
- [X] DL: finish transformers course
- [X] FCC-python: finish caesar course
- [X] DL: start AWS bedrock course
...
- #learn-python: [learn python the hard way](https://learnpythonthehardway.org/python3/)
- The pragmatic programmer
...
- [x] 3h expo-lab - node supabase back auth + openApi
  - Create getTodos on the frontend + connect api call to backend
- [x] 1h DL
- [] 1h FCC
...
- [x] 3h expo-lab commit
- [x] DL: crewAi 1 lesson
- [ ] FCC https://www.freecodecamp.org/learn/coding-interview-prep/algorithms/find-the-symmetric-difference


### Resources
- #OpenApi: https://medium.com/geekculture/de-duping-the-duplication-in-services-featuring-swagger-openapi-and-ajv-abd22c8c764e
- 
...
- [x] 3h expo-lab min commit. node api
- [] 1h FCC SQL
- [x] 0.5h DL:  Multi AI agent sys with crewAI

### Resources
- #learn-cleancode https://12factor.net/config
- 
...
- [] 2h expo-lab min commit. node api
- [] 1h FCC SQL
- [] 1h DL:  Multi AI agent sys with crewAI

### TODO

- [x] expo-lab min commit. Node Api
- [x] FCC SQL
- [x] DL 
